  ...
  const [messages, setMessages] = useState([
    {
      ...
      user: "AI",
      content:
        "Welcome to Talking Resume! We shall begin with your Interview now!!",
    ...
    <div className="chat-container min-h-screen flex flex-col">
            ...
            <div className="chat-history overflow-y-auto px-4 py-8 flex-grow">
              {messages.map((msg, index) => (
                ...
                >
                  ...
                  >
                    <div className="text-sm text-black-200">{msg.user}</div>
                    {msg.sender === "ai" ? (
                      <div
                        className="text-lg"
      ...
      <div className="flex justify-center items-center">
        <button
          ...
          className="m-4 group flex animate-bounce items-center justify-center rounded py-2 px-4 text-center font-bold bg-sky-800 text-white hover:bg-indigo-600"
        >
